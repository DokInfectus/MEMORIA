...
def main():
    section("MEMORIA PROMPT ENGINE LIVE TEST")
    ...
    try:
        ...
        final_prompt = engine.generate(
            ...
            system_prompt="You are MEMORIA runtime test mode.",
    ...
    section("Result")
    status("Prompt Engine Live Test", "completed", ok=True)
